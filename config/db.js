...
import pkg from 'pg'; // CommonJS 모듈을 default import로 가져옴
const { Pool } = pkg; // Pool을 구조 분해 할당
// import { Pool } from 'pg';
...
const pool = new Pool({
  ...
  max: 100,  // 최대 연결 수 (옵션)
  idleTimeoutMillis: 300000,  // 연결이 유휴 상태일 때 종료되는 시간 (옵션)
  connectionTimeoutMillis: 5000,  // 연결할 때까지 기다리는 시간 (옵션)
});
